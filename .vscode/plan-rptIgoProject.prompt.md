...
### Steps
1. DONE Update data extraction logic in [`rpt_igo_project/main.py`](src/reports/rpt_igo_project/main.py) to use Athena UNLOAD to Parquet. 
2. DONE Implement Parquet file reading in Python (e.g., with `pandas.read_parquet`).
...
4. Use existing, or build out new reusable functions in the athnea.py module 
