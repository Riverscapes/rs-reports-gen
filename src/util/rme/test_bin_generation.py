...
from util.rme.rme_common_dataprep import add_common_rme_cols, bins_continuous_equal_width
...
def main():
    ...
    df = pd.DataFrame({'value': [2.3, 5.1, 7.8, 10.2, 12.5, 12.6, 15.0, 18.7, 20.0, 22.4, 25.6, 999]})
    ...
    meta.field_meta = get_field_metadata()  # Set the field metadata for the report
