...
This means that you can use any [Riverscapes Viewer](https://viewer.riverscapes.net) (for QGIS or ArcGIS) to explore the contents with pre-defined views and symbology. However the data formats are all open and you can use your favourite tools to work with any of these files.

## Details of Folder Contents

* `report.html` A report summarizing the geographic coverage and riverscape footprint of the selected area.
